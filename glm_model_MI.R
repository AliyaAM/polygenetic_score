...
#instead of Cox proportional Oddsmodel, they used the AFT survival model (Sasty et al., 1997) 
...
#data_glm_ELSA = data.frame(ELSA_data_with_PGS$age)
...
data_glm_ELSA_initial = data.frame(ID,
                                   MI_outcome,
                                   follow_up, 
                                   age,
                                   sex, 
...
length(unique(data_glm_ELSA_initial$ID))

summary(data_glm_ELSA_initial)

data_glm_ELSA_table = data.table(data_glm_ELSA_initial)
data_glm_ELSA= na.omit(data_glm_ELSA_table, cols = c("MI_outcome", "PGS", "baseline_discriminaition"))
length(unique(data_glm_ELSA$ID))

summary(data_glm_ELSA)

Univariate_ELSA_MI_outcome_discrim = summary( glm(MI_outcome  ~ baseline_discriminaition, family = binomial(link = "logit"), data_glm_ELSA))
M_uni_interaction = glm(MI_outcome  ~ PGS*baseline_discriminaition, family = binomial(link = "logit"), data_glm_ELSA)
...
Model_1_ELSA_MI_outcome_gene = summary( glm(MI_outcome  ~ PGS + age + sex + wealth + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = binomial(link = "logit"), data_glm_ELSA))
Model_1_ELSA_MI_outcome_discrim = summary( glm(MI_outcome  ~ baseline_discriminaition + age + sex + wealth, family = binomial(link = "logit"), data_glm_ELSA))
...
M_1_interaction = glm(MI_outcome  ~ PGS*baseline_discriminaition + age + sex + wealth + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = binomial(link = "logit"), data_glm_ELSA)
...
Model_2_ELSA_MI_outcome_gene = summary( glm(MI_outcome  ~ PGS + age + sex + wealth + alcohol + smoking + physical_activity + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = binomial(link = "logit"), data_glm_ELSA))
Model_2_ELSA_MI_outcome_discrim = summary( glm(MI_outcome  ~ baseline_discriminaition + age + sex + wealth + alcohol + smoking + physical_activity, family = binomial(link = "logit"), data_glm_ELSA))

M_2_interaction = glm(MI_outcome  ~ PGS*baseline_discriminaition + age + sex + wealth + alcohol + smoking + physical_activity +  pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = binomial(link = "logit"), data_glm_ELSA)
...
########## alcohol: 
Model_2a_ELSA_MI_outcome_gene = summary( glm(MI_outcome  ~ PGS + age + sex + wealth + alcohol + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = binomial(link = "logit"), data_glm_ELSA))
Model_2a_ELSA_MI_outcome_discrim = summary( glm(MI_outcome  ~ baseline_discriminaition + age + sex + wealth + alcohol, family = binomial(link = "logit"), data_glm_ELSA))

M_2a_interaction = glm(MI_outcome  ~ PGS*baseline_discriminaition + age + sex + wealth + alcohol +  pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = binomial(link = "logit"), data_glm_ELSA)
...
Model_2as_ELSA_MI_outcome_gene = summary( glm(MI_outcome  ~ PGS + age + sex + wealth + smoking + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = binomial(link = "logit"), data_glm_ELSA))
Model_2as_ELSA_MI_outcome_discrim = summary( glm(MI_outcome  ~ baseline_discriminaition + age + sex + wealth + smoking, family = binomial(link = "logit"), data_glm_ELSA))

M_2s_interaction = glm(MI_outcome  ~ PGS*baseline_discriminaition + age + sex + wealth + smoking +  pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = binomial(link = "logit"), data_glm_ELSA)
...
#scale(smoking) + scale(physical_activity) +
Model_2apa_ELSA_MI_outcome_gene = summary( glm(MI_outcome  ~ PGS + age + sex + wealth + physical_activity + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = binomial(link = "logit"), data_glm_ELSA))
Model_2apa_ELSA_MI_outcome_discrim = summary( glm(MI_outcome  ~ baseline_discriminaition + age + sex + wealth + physical_activity, family = binomial(link = "logit"), data_glm_ELSA))

M_2pa_interaction = glm(MI_outcome  ~ PGS*baseline_discriminaition + age + sex + wealth + physical_activity +  pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = binomial(link = "logit"), data_glm_ELSA)
...
Model_3_ELSA_MI_outcome_gene = summary( glm(MI_outcome  ~ PGS + age + sex + wealth +  diabetes_history + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = binomial(link = "logit"), data_glm_ELSA))
Model_3_ELSA_MI_outcome_discrim = summary( glm(MI_outcome  ~ baseline_discriminaition + age + sex + wealth + diabetes_history, family = binomial(link = "logit"), data_glm_ELSA))

M_3_interaction = glm(MI_outcome  ~ PGS*baseline_discriminaition + age + sex + wealth + diabetes_history + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = binomial(link = "logit"), data_glm_ELSA)
...
Model_4_ELSA_MI_outcome_gene = summary( glm(MI_outcome  ~ PGS + age + sex + wealth + depression + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = binomial(link = "logit"), data_glm_ELSA))
Model_4_ELSA_MI_outcome_discrim = summary( glm(MI_outcome  ~ baseline_discriminaition + age + sex + wealth  + depression, family = binomial(link = "logit"), data_glm_ELSA))
M_4_interaction = glm(MI_outcome  ~ PGS*baseline_discriminaition + age + sex + wealth + depression + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = binomial(link = "logit"), data_glm_ELSA)
...
Model_5_ELSA_MI_outcome_gene = summary( glm(MI_outcome  ~ PGS + age + sex + wealth + alcohol + smoking + physical_activity + diabetes_history + depression + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = binomial(link = "logit"), data_glm_ELSA))
Model_5_ELSA_MI_outcome_discrim = summary( glm(MI_outcome  ~ baseline_discriminaition + age + sex + wealth + alcohol + smoking + physical_activity + diabetes_history + depression, family = binomial(link = "logit"), data_glm_ELSA))

M_5_interaction = glm(MI_outcome  ~ PGS*baseline_discriminaition + age + sex + wealth + alcohol + smoking + physical_activity + diabetes_history + depression +  pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = binomial(link = "logit"), data_glm_ELSA)
...
set_label(data_glm_ELSA$MI_outcome) <- "Myocardial Infarction"

plot_M_uni_int = plot_model(title = "",
                            axis.title = "OddsRatio",
                            type = "std2", 
                            show.values = TRUE, 
                            show.p = TRUE, 
                            M_uni_interaction,
