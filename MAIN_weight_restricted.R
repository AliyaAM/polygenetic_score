...
ELSA_data_with_PGS$w4bmi_clean_bin = case_when(ELSA_data_with_PGS$w4bmi_clean >= 30 ~ '1',
                                               ELSA_data_with_PGS$w4bmi_clean < 30 ~ '0')


subsetting_VAR1_ELSA = "w4bmi_clean_bin"
