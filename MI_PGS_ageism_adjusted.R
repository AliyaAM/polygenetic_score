...
write.csv(mi_results_ELSA, file = paste(OUTPUT_ROOT, "mi_results_ELSA_adjusted_ageism.csv", sep = ""))
...
write.csv(MI_ELSA_composite, file = paste(OUTPUT_ROOT, "MI_ELSA_composite_adjusted_ageism.csv", sep = ""))
...
write.csv(MI_ELSA_composite_pca, file = paste(OUTPUT_ROOT, "MI_ELSA_composite_pca_adjusted_ageism.csv", sep = ""))
...
write.csv(mi_results_ELSA_pca, file = paste(OUTPUT_ROOT, "mi_results_ELSA_pca_adjusted_ageism.csv", sep = ""))
...
write.csv(mi_results_HRS_pca, file = paste(OUTPUT_ROOT, "mi_results_HRS_pca_adjusted_ageism.csv", sep = ""))
...
write.csv(MI_HRS_composite, file = paste(OUTPUT_ROOT, "MI_HRS_composite_adjusted_ageism.csv", sep = ""))
...
write.csv(MI_HRS_composite_pca, file = paste(OUTPUT_ROOT, "MI_HRS_composite_pca_adjusted_ageism.csv", sep = ""))
