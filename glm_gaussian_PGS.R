glm_model_PGS = function(data_glm_input,  baseline_discriminaition, outcome, PGS)
{
  ...
  data_glm_input$baseline_discriminaition = data_glm_input[ ,   baseline_discriminaition]
  
  Univariate_outcome_discrim = summary( glm(data_glm_input[ ,   outcome] ~ baseline_discriminaition, family = gaussian, data_glm_input))
  M_uni_interaction = glm(data_glm_input[ ,   outcome] ~ PGS*baseline_discriminaition, family = gaussian, data_glm_input)
  ...
  #data_glm_input = data.frame(_data_with_PGS$age)
  #from literature: Model 1: Age, race, education, family income, marital status
  Model_1_outcome_gene = summary( glm(data_glm_input[ ,   outcome] ~ PGS + age + sex + wealth + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10,  family = gaussian, data_glm_input))
  Model_1_outcome_discrim = summary( glm(data_glm_input[ ,   outcome] ~ baseline_discriminaition + age + sex + wealth, family = gaussian, data_glm_input))
  
  # plot interaction: https://stats.stackexchange.com/questions/464700/representing-interaction-plot-for-glmph-model-using-plot-model-in-r
  M_1_interaction = glm(data_glm_input[ ,   outcome] ~ PGS*baseline_discriminaition + age + sex + wealth + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = gaussian, data_glm_input)
  ...
  Model_2_outcome_gene = summary( glm(data_glm_input[ ,   outcome] ~ PGS + age + sex + wealth + alcohol + smoking + physical_activity + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = gaussian, data_glm_input))
  Model_2_outcome_discrim = summary( glm(data_glm_input[ ,   outcome] ~ baseline_discriminaition + age + sex + wealth + alcohol + smoking + physical_activity, family = gaussian, data_glm_input))
  
  M_2_interaction = glm(data_glm_input[ ,   outcome] ~ PGS*baseline_discriminaition + age + sex + wealth + alcohol + smoking + physical_activity +  pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = gaussian, data_glm_input)
  ...
  ########## alcohol: 
  Model_2a_outcome_gene = summary( glm(data_glm_input[ ,   outcome] ~ PGS + age + sex + wealth + alcohol + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = gaussian, data_glm_input))
  Model_2a_outcome_discrim = summary( glm(data_glm_input[ ,   outcome] ~ baseline_discriminaition + age + sex + wealth + alcohol, family = gaussian, data_glm_input))
  
  M_2a_interaction = glm(data_glm_input[ ,   outcome] ~ PGS*baseline_discriminaition + age + sex + wealth + alcohol +  pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = gaussian, data_glm_input)
  ...
  Model_2s_outcome_gene = summary( glm(data_glm_input[ ,   outcome] ~ PGS + age + sex + wealth + smoking + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = gaussian, data_glm_input))
  Model_2s_outcome_discrim = summary( glm(data_glm_input[ ,   outcome] ~ baseline_discriminaition + age + sex + wealth + smoking, family = gaussian, data_glm_input))
  
  M_2s_interaction = glm(data_glm_input[ ,   outcome] ~ PGS*baseline_discriminaition + age + sex + wealth + smoking +  pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = gaussian, data_glm_input)
  ...
  #scale(smoking) + scale(physical_activity) +
  Model_2pa_outcome_gene = summary( glm(data_glm_input[ ,   outcome] ~ PGS + age + sex + wealth + physical_activity + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = gaussian, data_glm_input))
  Model_2pa_outcome_discrim = summary( glm(data_glm_input[ ,   outcome] ~ baseline_discriminaition + age + sex + wealth + physical_activity, family = gaussian, data_glm_input))
  
  M_2pa_interaction = glm(data_glm_input[ ,   outcome] ~ PGS*baseline_discriminaition + age + sex + wealth + physical_activity +  pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = gaussian, data_glm_input)
  ...
  Model_3_outcome_gene = summary( glm(data_glm_input[ ,   outcome] ~ PGS + age + sex + wealth +  diabetes_history + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = gaussian, data_glm_input))
  Model_3_outcome_discrim = summary( glm(data_glm_input[ ,   outcome] ~ baseline_discriminaition + age + sex + wealth + diabetes_history, family = gaussian, data_glm_input))
  
  M_3_interaction = glm(data_glm_input[ ,   outcome] ~ PGS*baseline_discriminaition + age + sex + wealth + diabetes_history + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = gaussian, data_glm_input)
  ...
  Model_4_outcome_gene = summary( glm(data_glm_input[ ,   outcome] ~ PGS + age + sex + wealth + depression + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = gaussian, data_glm_input))
  Model_4_outcome_discrim = summary( glm(data_glm_input[ ,   outcome] ~ baseline_discriminaition + age + sex + wealth  + depression, family = gaussian, data_glm_input))
  M_4_interaction = glm(data_glm_input[ ,   outcome] ~ PGS*baseline_discriminaition + age + sex + wealth + depression + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = gaussian, data_glm_input)
  ...
  Model_5_outcome_gene = summary( glm(data_glm_input[ ,   outcome] ~ PGS + age + sex + wealth + alcohol + smoking + physical_activity + diabetes_history + depression + pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = gaussian, data_glm_input))
  Model_5_outcome_discrim = summary( glm(data_glm_input[ ,   outcome] ~ baseline_discriminaition + age + sex + wealth + alcohol + smoking + physical_activity + diabetes_history + depression, family = gaussian, data_glm_input))
  
  M_5_interaction = glm(data_glm_input[ ,   outcome] ~ PGS*baseline_discriminaition + age + sex + wealth + alcohol + smoking + physical_activity + diabetes_history + depression +  pc1 + pc2 + pc3 + pc4 + pc5 + pc6 + pc7 + pc8 + pc9 + pc10, family = gaussian, data_glm_input)
  ...
  output_1 = head(Univariate_outcome_discrim_results, 2)
  output_2 = tail(Univariate_outcome_gene_interaction_results, 1)
  
  output_3 = head(Model_1_outcome_gene_results, 2)
  output_4 = head(Model_1_outcome_discrim_results, 2)
  output_5 = tail(Model_1_outcome_gene_interaction_results, 1)
  
  output_6 = head(Model_2_outcome_gene_results, 2)
  output_7 = head(Model_2_outcome_discrim_results, 2)
  output_8 = tail(Model_2_outcome_gene_interaction_results, 1)
  
  output_9 = head(Model_2a_outcome_gene_results, 2)
  output_10 = head(Model_2a_outcome_discrim_results, 2)
  output_11 = tail(Model_2a_outcome_gene_interaction_results, 1)
  
  
  output_12 = head(Model_2s_outcome_gene_results, 2)
  output_13 = head(Model_2s_outcome_discrim_results, 2)
  output_14 = tail(Model_2s_outcome_gene_interaction_results, 1)
  
  
  output_15 = head(Model_2pa_outcome_gene_results, 2)
  output_16 = head(Model_2pa_outcome_discrim_results, 2)
  output_17 = tail(Model_2pa_outcome_gene_interaction_results, 1)
  
  output_18 = head(Model_3_outcome_gene_results, 2)
  output_19 = head(Model_3_outcome_discrim_results, 2)
  output_20 = tail(Model_3_outcome_gene_interaction_results, 1)
  
  output_21 = head(Model_4_outcome_gene_results, 2)
  output_22 = head(Model_4_outcome_discrim_results, 2)
  output_23 = tail(Model_4_outcome_gene_interaction_results, 1)
  
  output_24 = head(Model_4_outcome_gene_results, 2)
  output_25 = head(Model_4_outcome_discrim_results, 2)
