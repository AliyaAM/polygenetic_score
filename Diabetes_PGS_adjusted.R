...
ELSA_data_with_PGS  = subset(ELSA_data_with_PGS_before_subsetting_to_baseline_free, ELSA_data_with_PGS_before_subsetting_to_baseline_free$w5diabetes_new == 0 & ELSA_data_with_PGS_before_subsetting_to_baseline_free$w5diabetes_ever == 0)
all_HRS_by_years_PGS  = subset(all_HRS_by_years_PGS_before_subsetting_to_baseline_free, all_HRS_by_years_PGS_before_subsetting_to_baseline_free$HRS2010_diabetes_ever == 0 & all_HRS_by_years_PGS_before_subsetting_to_baseline_free$HRS2010_diabetes_new == 0)
...
OUTPUT_ROOT = paste(directory, "KCL_postDoc/Data_analysis/polygenetic_score/RESULTS/diabetes/diabetes_adjusted_discrim_bin/", sep = "")
...
write.csv(diabetes_results_ELSA, file = paste(OUTPUT_ROOT, "diabetes_results_ELSA_adjusted.csv", sep = ""))
...
write.csv(diabetes_results_HRS, file = paste(OUTPUT_ROOT, "diabetes_results_HRS_adjusted.csv", sep = ""))
...
write.csv(diabetes_results_ELSA_pca, file = paste(OUTPUT_ROOT, "diabetes_results_ELSA_pca_adjusted.csv", sep = ""))
...
write.csv(diabetes_results_HRS_pca, file = paste(OUTPUT_ROOT, "diabetes_results_HRS_pca_adjusted.csv", sep = ""))
...
write.csv(diabetes_ELSA_composite, file = paste(OUTPUT_ROOT, "diabetes_ELSA_composite_adjusted.csv", sep = ""))
...
write.csv(diabetes_ELSA_composite_pca, file = paste(OUTPUT_ROOT, "diabetes_ELSA_composite_pca_adjusted.csv", sep = ""))
...
write.csv(diabetes_HRS_composite, file = paste(OUTPUT_ROOT, "diabetes_HRS_composite_adjusted.csv", sep = ""))
...
write.csv(diabetes_HRS_composite_pca, file = paste(OUTPUT_ROOT, "diabetes_HRS_composite_pca_adjusted.csv", sep = ""))
