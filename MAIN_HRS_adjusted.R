...
#covariates in HRS: 
#all_HRS_by_years_PGS$HRS2010_continious_age
#all_HRS_by_years_PGS$HRS2010_
#all_HRS_by_years_PGS$HRS2010_wealth_noIRA

covariate1 = "HRS2010_continious_age"
covariate2 = "HRS2010_sex_1_0"
covariate3 = "HRS2010_wealth_noIRA"
covariate4 = "NA"
...
HRS_results_all_discrim_bin_adjusted = rbind(#hypertension_results, 
  diabetes_results,  
...
write.csv(HRS_results_all_discrim_bin_adjusted, file = paste(SOURCE_ROOT, "HRS_results_all_discrim_bin_adjusted.csv", sep=""))
