...
OUTPUT_ROOT = paste(directory, "proj/polygenetic_score/OUTPUT/wave_5_outcome", sep = "")
...
data_cox_ELSA_initial$MI_outcome_wave_5 = c(ELSA_data_with_PGS$w5_mi_new_bin_g2)
...
unique(data_cox_ELSA_initial$PGS_depres_symp)
...
data_cox_HRS_initial$MI_outcome_wave_5 = c(all_HRS_by_years_PGS$HRS2010_mi_bin)
...
ELSA_results_mi = cox_model_PGS(data_cox_input = data_cox_ELSA,
                                ...
                                analysis_name = "ELSA_results_mi_cox_wave_5", 
...
ELSA_results_mi_glm = glm_model_PGS(data_glm_input = data_cox_ELSA, 
                                    ...
                                    OUTPUT_ROOT = OUTPUT_ROOT, 
                                    alternative_cov = "diabetes_history", 
                                    analysis_name = "ELSA_results_mi_glm_wave_5", 
...
ELSA_results_mi_glm_nobaseline = glm_model_PGS(data_glm_input = data_glm_ELSA_NObaseline_cases_mi, 
                                               ...
                                               OUTPUT_ROOT = OUTPUT_ROOT, 
                                               alternative_cov = "diabetes_history", 
                                               analysis_name = "ELSA_results_mi_glm_no_baseline_cases_wave_5", 
...
HRS_results_mi = cox_model_PGS(data_cox_input = data_cox_HRS, 
                               ...
                               OUTPUT_ROOT = OUTPUT_ROOT, 
                               alternative_cov = "diabetes_history", 
                               analysis_name = "HRS_results_mi_cox_wave_5", 
...
HRS_results_mi_glm = glm_model_PGS(data_glm_input = data_cox_HRS, 
                                   ...
                                   OUTPUT_ROOT = OUTPUT_ROOT, 
                                   alternative_cov = "diabetes_history", 
                                   analysis_name = "HRS_results_mi_glm_wave_5", 
...
HRS_results_mi_glm_nobaseline = glm_model_PGS(data_glm_input = data_glm_HRS_NObaseline_cases_mi, 
                                              ...
                                              OUTPUT_ROOT = OUTPUT_ROOT, 
                                              alternative_cov = "diabetes_history", 
                                              analysis_name = "HRS_results_mi_glm_no_baseline_wave_5", 
...
#                                           OUTPUT_ROOT = OUTPUT_ROOT, 
#                                           alternative_cov = "BMI", 
#                                           analysis_name = "ELSA_results_diab_cox_wave_5", 
...
#                                           alternative_cov = "BMI", 
#                                           
#                                           analysis_name = "ELSA_results_diab_glm_wave_5", 
...
#                                                      alternative_cov = "BMI", 
#                                                      
#                                                      analysis_name = "ELSA_results_diab_glm_no_baseline_wave_5", 
...
#                                      alternative_cov = "BMI", 
#                                      
#                                      analysis_name = "HRS_results_diab_cox_wave_5", 
...
#                                          alternative_cov = "BMI", 
#                                          
#                                          analysis_name = "HRS_results_diab_glm_wave_5", 
...
#                                                     alternative_cov = "BMI", 
#                                                     
#                                                     analysis_name = "HRS_results_diab_glm_no_baseline_wave_5", 
...
ELSA_results_depressive_symp_glm = glm_gaussian_PGS(data_glm_input = data_glm_gaussian_ELSA, 
                                                    ...
                                                    analysis_name = "ELSA_results_depressive_glm_wave_5", 
                                                    plot_name = "ELSA, T2DM, GLM: ")
...
HRS_results_depressive_symp_glm = glm_gaussian_PGS(data_glm_input = data_glm_gaussian_HRS, 
                                                   ...
                                                   analysis_name = "HRS_results_depressive_glm_wave_5", 
                                                   plot_name = "HRS, T2DM, GLM: ")
