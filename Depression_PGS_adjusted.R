...
OUTPUT_ROOT = paste(directory, "KCL_postDoc/Data_analysis/polygenetic_score/RESULTS/depression/depression_adjusted_discrim_bin/", sep = "")
...
write.csv(depression_results_ELSA, file = paste(OUTPUT_ROOT, "depression_results_ELSA_adjusted.csv", sep = ""))
...
write.csv(depression_results_HRS, file = paste(OUTPUT_ROOT, "depression_results_HRS_adjusted.csv", sep = ""))
...
write.csv(depression_results_ELSA_pca, file = paste(OUTPUT_ROOT, "depression_results_ELSA_pca_adjusted.csv", sep = ""))
...
write.csv(depression_results_HRS_pca, file = paste(OUTPUT_ROOT, "depression_results_HRS_pca_adjusted.csv", sep = ""))
...
write.csv(depression_ELSA_composite, file = paste(OUTPUT_ROOT, "depression_ELSA_composite_adjusted.csv", sep = ""))
...
write.csv(depression_ELSA_composite_pca, file = paste(OUTPUT_ROOT, "depression_ELSA_composite_pca_adjusted.csv", sep = ""))
...
write.csv(depression_HRS_composite, file = paste(OUTPUT_ROOT, "depression_HRS_composite_adjusted.csv", sep = ""))
...
write.csv(depression_HRS_composite_pca, file = paste(OUTPUT_ROOT, "depression_HRS_composite_pca_adjusted.csv", sep = ""))
