...
HRS_results_ageism_adjusted = rbind(#hypertension_results, 
  diabetes_results,  
...
write.csv(HRS_results_ageism_adjusted, file = paste(SOURCE_ROOT, "HRS_results_ageism_adjusted.csv", sep=""))
