...
folder_unadjusted = paste("depression_unadjusted_ageism/", sep = "")
folder_adjusted = paste("depression_adjusted_dageism/", sep = "")
...
write.csv(Table_depression, file = paste(directory, OUTPUT, "Table_depression_per_wave_ageism.csv", sep = ""))
...
write.csv(Table_composite_depression, file = paste(directory, OUTPUT, "Table_composite_depression_ageism.csv", sep = ""))
