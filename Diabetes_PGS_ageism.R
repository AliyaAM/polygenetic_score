...
OUTPUT_ROOT = paste(directory, "KCL_postDoc/Data_analysis/polygenetic_score/RESULTS/diabetes/diabetes_unadjusted_ageism/", sep = "")
...
write.csv(diabetes_results_ELSA, file = paste(OUTPUT_ROOT, "diabetes_results_ELSA_unadjusted_ageism.csv", sep = ""))
...
write.csv(diabetes_results_HRS, file = paste(OUTPUT_ROOT, "diabetes_results_HRS_unadjusted_ageism.csv", sep = ""))
...
write.csv(diabetes_results_ELSA_pca, file = paste(OUTPUT_ROOT, "diabetes_results_ELSA_pca_unadjusted_ageism.csv", sep = ""))
...
write.csv(diabetes_results_HRS_pca, file = paste(OUTPUT_ROOT, "diabetes_results_HRS_pca_unadjusted_ageism.csv", sep = ""))
...
write.csv(diabetes_ELSA_composite, file = paste(OUTPUT_ROOT, "diabetes_ELSA_composite_unadjusted_ageism.csv", sep = ""))
...
write.csv(diabetes_ELSA_composite_pca, file = paste(OUTPUT_ROOT, "diabetes_ELSA_composite_pca_unadjusted_ageism.csv", sep = ""))
...
write.csv(diabetes_HRS_composite, file = paste(OUTPUT_ROOT, "diabetes_HRS_composite_unadjusted_ageism.csv", sep = ""))
...
write.csv(diabetes_HRS_composite_pca, file = paste(OUTPUT_ROOT, "diabetes_HRS_composite_pca_unadjusted_ageism.csv", sep = ""))
