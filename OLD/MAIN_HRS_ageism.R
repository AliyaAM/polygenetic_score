...
#unique(all_HRS_by_years_PGS$HRS2010_reason_discrim1_reason_age)
...
HRS_results_ageism_unadjusted = rbind(#hypertension_results, 
  diabetes_results,  
...
write.csv(HRS_results_ageism_unadjusted, file = paste(SOURCE_ROOT, "HRS_results_ageism_unadjusted.csv", sep=""))
