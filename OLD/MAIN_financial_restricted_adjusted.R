...
ELSA_data_with_PGS$medianWealth_ELSA = median(ELSA_data_with_PGS$w5wealth, na.rm = TRUE)
#ELSA median: 652000
#creating a new binary variable: 
ELSA_data_with_PGS$median_wealth_bin_ELSA = case_when(ELSA_data_with_PGS$w5wealth >= 252000 ~'2',
                                                      ELSA_data_with_PGS$w5wealth < 252000 ~ '1')


ELSA_data_with_PGS$SES = case_when(ELSA_data_with_PGS$median_wealth_bin_ELSA == '2' ~ '2',
                                   ELSA_data_with_PGS$median_wealth_bin_ELSA == '1' ~ '1')



ELSA_var1_value = 1

subsetting_VAR1_ELSA = "SES"
