...
ELSA_results_all_discrim_bin_adjusted = rbind(diabetes_results,  
                                                diabetes_results_v2, 
                                                mi_results,  
                                                pain_results,  
...
write.csv(ELSA_results_all_discrim_bin_adjusted, file = paste(SOURCE_ROOT, "ELSA_results_all_discrim_bin_adjusted.csv", sep=""))
