...
OUTPUT_ROOT = paste(directory, "KCL_postDoc/Data_analysis/polygenetic_score/RESULTS/MI/MI_ageism_unadjusted/", sep = "")
...
write.csv(mi_results_ELSA, file = paste(OUTPUT_ROOT, "mi_results_ELSA_unadjusted_ageism.csv", sep = ""))
...
write.csv(mi_results_HRS, file = paste(OUTPUT_ROOT, "mi_results_HRS_unadjusted_ageism.csv", sep = ""))
...
write.csv(mi_results_ELSA_pca, file = paste(OUTPUT_ROOT, "mi_results_ELSA_pca_unadjusted_ageism.csv", sep = ""))
...
write.csv(mi_results_HRS_pca, file = paste(OUTPUT_ROOT, "mi_results_HRS_pca_unadjusted_ageism.csv", sep = ""))
...
write.csv(MI_ELSA_composite, file = paste(OUTPUT_ROOT, "MI_ELSA_composite_unadjusted_ageism.csv", sep = ""))
...
write.csv(MI_ELSA_composite_pca, file = paste(OUTPUT_ROOT, "MI_ELSA_composite_pca_unadjusted_ageism.csv", sep = ""))
...
write.csv(MI_HRS_composite, file = paste(OUTPUT_ROOT, "MI_HRS_composite_unadjusted_ageism.csv", sep = ""))
...
write.csv(MI_HRS_composite_pca, file = paste(OUTPUT_ROOT, "MI_HRS_composite_pca_unadjusted_ageism.csv", sep = ""))
