...
#https://www.rdocumentation.org/packages/flexsurv/versions/2.2/topics/flexsurvreg


#from Ajnakina paper (ementia paper with PGS): To identify the best fitting parametric model (ie, exponential, gamma, lognormal, and gamma), we used the Akaike information criterion that showed the gamma model was the most appropriate for our analyses. The parameter coefficients from the AFT model were converted into mean difference in the time to dementia diagnosis through the equation ((eβ − 1)×mean time to diagnosis).
...
#instead of AFT proportional hazard model, they used the AFT survival model (Sasty et al., 1997) 
...
OUTPUT_ROOT = paste(directory, "proj/polygenetic_score/OUTPUT/AFT/", sep = "")

folder <- paste(OUTPUT_ROOT)
...
#source(paste(SOURCE_ROOT, "AFT_model_PGS.R", sep=""))
...
data_AFT_ELSA_initial = data.frame(ID_ELSA)
...
data_AFT_ELSA_initial$MI_outcome = c(ELSA_data_with_PGS$w5_mi_new_bin_g2,
                                     ELSA_data_with_PGS$w6_mi_new_bin_g2,
                                     ELSA_data_with_PGS$w7_mi_new_bin_g2,
                                     ELSA_data_with_PGS$w8_mi_new_bin_g2)


# data_AFT_ELSA_initial$MI_outcome = c(ELSA_data_with_PGS$w5_MI_new_bin,
#                                      ELSA_data_with_PGS$w6_MI_new_bin,
#                                      ELSA_data_with_PGS$w7_MI_new_bin,
#                                      ELSA_data_with_PGS$w8_MI_new_bin)

unique(data_AFT_ELSA_initial$MI_outcome)
table(data_AFT_ELSA_initial$MI_outcome)
...
data_AFT_ELSA_initial$time_point = c(time_point_1_ELSA, 
                                     time_point_2_ELSA,
                                     time_point_3_ELSA,
                                     time_point_4_ELSA)

data_AFT_ELSA_initial$years = data_AFT_ELSA_initial$time_point

data_AFT_ELSA_initial$follow_up = data_AFT_ELSA_initial$years


data_AFT_ELSA_initial$age = c(ELSA_data_with_PGS$w5age,
                              ELSA_data_with_PGS$w6age, 
                              ELSA_data_with_PGS$w7age, 
                              ELSA_data_with_PGS$w8age)


data_AFT_ELSA_initial$sex = c(ELSA_data_with_PGS$w5sex,
                              ELSA_data_with_PGS$w6sex, 
                              ELSA_data_with_PGS$w7sex, 
                              ELSA_data_with_PGS$w8sex)

data_AFT_ELSA_initial$PGS_mi = c(ELSA_data_with_PGS$MI, 
...
data_AFT_ELSA_initial$wealth = c(ELSA_data_with_PGS$w5wealth, 
                                 ELSA_data_with_PGS$w6wealth, 
                                 ELSA_data_with_PGS$w7wealth, 
                                 ELSA_data_with_PGS$w7wealth)

data_AFT_ELSA_initial$baseline_discriminaition = c(ELSA_data_with_PGS$w5discrim_bin, 
                                                   ELSA_data_with_PGS$w5discrim_bin, 
                                                   ELSA_data_with_PGS$w5discrim_bin, 
                                                   ELSA_data_with_PGS$w5discrim_bin)


data_AFT_ELSA_initial$discriminaition =  c(ELSA_data_with_PGS$w5discrim_bin, 
                                           ELSA_data_with_PGS$w6discrim_bin, 
                                           ELSA_data_with_PGS$w7discrim_bin, 
                                           ELSA_data_with_PGS$w8discrim_bin) 

unique(data_AFT_ELSA_initial$discriminaition)

data_AFT_ELSA_initial$pc1 = c(ELSA_data_with_PGS$pc1, 
                              ELSA_data_with_PGS$pc1, 
                              ELSA_data_with_PGS$pc1, 
                              ELSA_data_with_PGS$pc1) 


data_AFT_ELSA_initial$pc2 = c(ELSA_data_with_PGS$pc2, 
                              ELSA_data_with_PGS$pc2, 
                              ELSA_data_with_PGS$pc2, 
                              ELSA_data_with_PGS$pc2) 


data_AFT_ELSA_initial$pc3 = c(ELSA_data_with_PGS$pc3, 
                              ELSA_data_with_PGS$pc3, 
                              ELSA_data_with_PGS$pc3, 
                              ELSA_data_with_PGS$pc3) 


data_AFT_ELSA_initial$pc4 = c(ELSA_data_with_PGS$pc4, 
...
data_AFT_ELSA_initial$pc5 = c(ELSA_data_with_PGS$pc5, 
                              ELSA_data_with_PGS$pc5, 
                              ELSA_data_with_PGS$pc5, 
                              ELSA_data_with_PGS$pc5) 

data_AFT_ELSA_initial$pc6 = c(ELSA_data_with_PGS$pc6, 
                              ELSA_data_with_PGS$pc6, 
                              ELSA_data_with_PGS$pc6, 
                              ELSA_data_with_PGS$pc6) 

data_AFT_ELSA_initial$pc7 = c(ELSA_data_with_PGS$pc7, 
                              ELSA_data_with_PGS$pc7, 
                              ELSA_data_with_PGS$pc7, 
                              ELSA_data_with_PGS$pc7) 


data_AFT_ELSA_initial$pc8 = c(ELSA_data_with_PGS$pc8, 
                              ELSA_data_with_PGS$pc8, 
                              ELSA_data_with_PGS$pc8, 
                              ELSA_data_with_PGS$pc8) 


data_AFT_ELSA_initial$pc9 = c(ELSA_data_with_PGS$pc9, 
                              ELSA_data_with_PGS$pc9, 
                              ELSA_data_with_PGS$pc9, 
                              ELSA_data_with_PGS$pc9) 


data_AFT_ELSA_initial$pc10 = c(ELSA_data_with_PGS$pc10, 
                               ELSA_data_with_PGS$pc10, 
                               ELSA_data_with_PGS$pc10, 
                               ELSA_data_with_PGS$pc10) 

data_AFT_ELSA_initial$alcohol = c(ELSA_data_with_PGS$w5alcunits, 
...
unique(data_AFT_ELSA_initial$alcohol)

unique(ELSA_data_with_PGS$w5smokec)
unique(ELSA_data_with_PGS$w5smoket)

data_AFT_ELSA_initial$smoking = c(ELSA_data_with_PGS$w5smokenum, 
                                  ELSA_data_with_PGS$w6smokenum,
                                  ELSA_data_with_PGS$w7smokenum,
                                  ELSA_data_with_PGS$w7smokenum)


unique(data_AFT_ELSA_initial$smoking)


data_AFT_ELSA_initial$physical_activity  = c(ELSA_data_with_PGS$w5pacomb1, 
                                             ELSA_data_with_PGS$w6pacomb1,
                                             ELSA_data_with_PGS$w7pacomb1,
                                             ELSA_data_with_PGS$w7pacomb1)

unique(data_AFT_ELSA_initial$physical_activity)

print("  bmi was taken in w4, w6, w8, but not the other waves ")
data_AFT_ELSA_initial$BMI = c(ELSA_data_with_PGS$w4_bmi, 
                              ELSA_data_with_PGS$w4_bmi, 
                              ELSA_data_with_PGS$w6_bmi, 
                              ELSA_data_with_PGS$w8_bmi)

data_AFT_ELSA_initial$diabetes_history = c(ELSA_data_with_PGS$w5diabetes_ever,
                                           ELSA_data_with_PGS$w6diabetes_ever,
                                           ELSA_data_with_PGS$w7diabetes_ever,
                                           ELSA_data_with_PGS$w8diabetes_ever) 


unique(data_AFT_ELSA_initial$diabetes_history)

#ELSA_data_with_PGS$hypertension 


#add: hypertension_history stressful_event 
data_AFT_ELSA_initial$depression_original = c(ELSA_data_with_PGS$w5cesd, 
                                              ELSA_data_with_PGS$w6cesd, 
                                              ELSA_data_with_PGS$w7cesd, 
                                              ELSA_data_with_PGS$w8cesd) 

unique(data_AFT_ELSA_initial$depression_original)

data_AFT_ELSA_initial$depression = 8 - data_AFT_ELSA_initial$depression_original

data_AFT_ELSA_initial$PGS_diab = c(ELSA_data_with_PGS$T2D_2018, 
                                   ELSA_data_with_PGS$T2D_2018, 
                                   ELSA_data_with_PGS$T2D_2018, 
                                   ELSA_data_with_PGS$T2D_2018)


data_AFT_ELSA_initial$diabetes_outcome = c(ELSA_data_with_PGS$w5diabetes_new, 
...
data_AFT_ELSA_initial$PGS_depres_symp = c(ELSA_data_with_PGS$DS, 
...
data_AFT_ELSA_initial$depressive_symptoms = c(ELSA_data_with_PGS$w5cesd, 
                                              ELSA_data_with_PGS$w6cesd, 
                                              ELSA_data_with_PGS$w7cesd, 
                                              ELSA_data_with_PGS$w8cesd)


length(unique(data_AFT_ELSA_initial$ID))
summary(data_AFT_ELSA_initial)
...
data_AFT_ELSA_initial$loneliness = c(ELSA_data_with_PGS$w5_loneliness, 
...
data_AFT_ELSA_initial$loneliness3 = c(ELSA_data_with_PGS$w5_loneliness3, 
...
data_AFT_ELSA_initial$life_stress_event = c(ELSA_data_with_PGS$life_stress_event, 
                                            ELSA_data_with_PGS$life_stress_event, 
                                            ELSA_data_with_PGS$life_stress_event, 
                                            ELSA_data_with_PGS$life_stress_event)


unique(data_AFT_ELSA_initial$life_stress_event)


#summary score
data_AFT_ELSA_initial$chldhd_stress_event = c(ELSA_data_with_PGS$chldhd_stress_event, 
                                              ELSA_data_with_PGS$chldhd_stress_event, 
                                              ELSA_data_with_PGS$chldhd_stress_event, 
                                              ELSA_data_with_PGS$chldhd_stress_event)

unique(data_AFT_ELSA_initial$chldhd_stress_event)


#summary score

data_AFT_ELSA_initial$jobstress = c(ELSA_data_with_PGS$w5_jobstress, 
...
data_AFT_HRS_initial = data.frame(ID_HRS)

data_AFT_HRS_initial$MI_outcome = c(all_HRS_by_years_PGS$HRS2010_mi_bin,
                                    all_HRS_by_years_PGS$HRS2012_mi_bin,
                                    all_HRS_by_years_PGS$HRS2014_mi_bin,
                                    all_HRS_by_years_PGS$HRS2016_mi_bin)

unique(data_AFT_HRS_initial$MI_outcome)
table(data_AFT_HRS_initial$MI_outcome)
...
data_AFT_HRS_initial$time_point = c(time_point_1_HRS, 
                                    time_point_2_HRS,
                                    time_point_3_HRS,
                                    time_point_4_HRS)

data_AFT_HRS_initial$years = data_AFT_HRS_initial$time_point

data_AFT_HRS_initial$follow_up = data_AFT_HRS_initial$years

data_AFT_HRS_initial$age = c(all_HRS_by_years_PGS$HRS2010_continious_age,
...
data_AFT_HRS_initial$sex = c(all_HRS_by_years_PGS$HRS2010_sex_1_0,
                             all_HRS_by_years_PGS$HRS2012_sex_1_0, 
                             all_HRS_by_years_PGS$HRS2014_sex_1_0, 
                             all_HRS_by_years_PGS$HRS2014_sex_1_0)


data_AFT_HRS_initial$PGS_mi = c(all_HRS_by_years_PGS$E4_MI_CARDIOGRAM15, 
                                all_HRS_by_years_PGS$E4_MI_CARDIOGRAM15, 
                                all_HRS_by_years_PGS$E4_MI_CARDIOGRAM15, 
                                all_HRS_by_years_PGS$E4_MI_CARDIOGRAM15) 


data_AFT_HRS_initial$wealth = c(all_HRS_by_years_PGS$HRS2010_wealth_noIRA, 
...
data_AFT_HRS_initial$baseline_discriminaition = c(all_HRS_by_years_PGS$HRS2010_discrim_bin, 
                                                  all_HRS_by_years_PGS$HRS2010_discrim_bin, 
                                                  all_HRS_by_years_PGS$HRS2010_discrim_bin, 
                                                  all_HRS_by_years_PGS$HRS2010_discrim_bin)


data_AFT_HRS_initial$discriminaition =  c(all_HRS_by_years_PGS$HRS2010_discrim_bin, 
                                          all_HRS_by_years_PGS$HRS2012_discrim_bin, 
                                          all_HRS_by_years_PGS$HRS2014_discrim_bin, 
                                          all_HRS_by_years_PGS$HRS2016_discrim_bin) 

unique(data_AFT_HRS_initial$discriminaition)

data_AFT_HRS_initial$pc1 = c(all_HRS_by_years_PGS$pc1, 
                             all_HRS_by_years_PGS$pc1, 
                             all_HRS_by_years_PGS$pc1, 
                             all_HRS_by_years_PGS$pc1) 


data_AFT_HRS_initial$pc2 = c(all_HRS_by_years_PGS$pc2, 
                             all_HRS_by_years_PGS$pc2, 
                             all_HRS_by_years_PGS$pc2, 
                             all_HRS_by_years_PGS$pc2) 


data_AFT_HRS_initial$pc3 = c(all_HRS_by_years_PGS$pc3, 
                             all_HRS_by_years_PGS$pc3, 
                             all_HRS_by_years_PGS$pc3, 
                             all_HRS_by_years_PGS$pc3) 


data_AFT_HRS_initial$pc4 = c(all_HRS_by_years_PGS$pc4, 
...
data_AFT_HRS_initial$pc5 = c(all_HRS_by_years_PGS$pc5, 
                             all_HRS_by_years_PGS$pc5, 
                             all_HRS_by_years_PGS$pc5, 
                             all_HRS_by_years_PGS$pc5) 

data_AFT_HRS_initial$pc6 = c(all_HRS_by_years_PGS$pc6, 
                             all_HRS_by_years_PGS$pc6, 
                             all_HRS_by_years_PGS$pc6, 
                             all_HRS_by_years_PGS$pc6) 

data_AFT_HRS_initial$pc7 = c(all_HRS_by_years_PGS$pc7, 
                             all_HRS_by_years_PGS$pc7, 
                             all_HRS_by_years_PGS$pc7, 
                             all_HRS_by_years_PGS$pc7) 


data_AFT_HRS_initial$pc8 = c(all_HRS_by_years_PGS$pc8, 
                             all_HRS_by_years_PGS$pc8, 
                             all_HRS_by_years_PGS$pc8, 
                             all_HRS_by_years_PGS$pc8) 


data_AFT_HRS_initial$pc9 = c(all_HRS_by_years_PGS$pc9, 
                             all_HRS_by_years_PGS$pc9, 
                             all_HRS_by_years_PGS$pc9, 
                             all_HRS_by_years_PGS$pc9) 


data_AFT_HRS_initial$pc10 = c(all_HRS_by_years_PGS$pc10, 
                              all_HRS_by_years_PGS$pc10, 
                              all_HRS_by_years_PGS$pc10, 
                              all_HRS_by_years_PGS$pc10) 


data_AFT_HRS_initial$alcohol = c(all_HRS_by_years_PGS$HRS2010_alcohol_days_week, 
...
unique(data_AFT_HRS_initial$alcohol)


data_AFT_HRS_initial$smoking = c(all_HRS_by_years_PGS$HRS2010_smokes_ever_bin, 
...
unique(data_AFT_HRS_initial$smoking)

data_AFT_HRS_initial$physical_activity  = c(all_HRS_by_years_PGS$HRS2010_vigarious_physical_activity, 
...
unique(data_AFT_HRS_initial$physical_activity)

data_AFT_HRS_initial$BMI = c(all_HRS_by_years_PGS$HRS2010_BMI, 
                             all_HRS_by_years_PGS$HRS2012_BMI, 
                             all_HRS_by_years_PGS$HRS2014_BMI, 
                             all_HRS_by_years_PGS$HRS2016_BMI)


data_AFT_HRS_initial$diabetes_history = c(all_HRS_by_years_PGS$HRS2010_diabetes_ever,
...
unique(data_AFT_HRS_initial$diabetes_history)

#all_HRS_by_years_PGS$hypertension 

#add: hypertension_history stressful_event 

data_AFT_HRS_initial$depression = c(all_HRS_by_years_PGS$HRS2010_checklist_depression_bin, 
...
data_AFT_HRS_initial$PGS_diab = c(all_HRS_by_years_PGS$E4_T2D_DIAGRAM12, 
                                  all_HRS_by_years_PGS$E4_T2D_DIAGRAM12, 
                                  all_HRS_by_years_PGS$E4_T2D_DIAGRAM12, 
                                  all_HRS_by_years_PGS$E4_T2D_DIAGRAM12)


data_AFT_HRS_initial$diabetes_outcome = c(all_HRS_by_years_PGS$HRS2010_diabetes_new, 
...
data_AFT_HRS_initial$PGS_depres_symp = c(all_HRS_by_years_PGS$E4_DEPSYMP_SSGAC16, 
...
data_AFT_HRS_initial$depressive_symptoms = c(all_HRS_by_years_PGS$HRS2010_cesd, 
...
data_AFT_HRS_initial$loneliness = c(all_HRS_by_years_PGS$HRS2010_loneliness, 
...
data_AFT_HRS_initial$life_stress_event = c(all_HRS_by_years_PGS$life_stress_event, 
                                           all_HRS_by_years_PGS$life_stress_event, 
                                           all_HRS_by_years_PGS$life_stress_event, 
                                           all_HRS_by_years_PGS$life_stress_event)


unique(data_AFT_HRS_initial$life_stress_event)


#summary score
data_AFT_HRS_initial$chldhd_stress_event = c(all_HRS_by_years_PGS$chldhd_stress_event, 
                                             all_HRS_by_years_PGS$chldhd_stress_event, 
                                             all_HRS_by_years_PGS$chldhd_stress_event, 
                                             all_HRS_by_years_PGS$chldhd_stress_event)

unique(data_AFT_HRS_initial$chldhd_stress_event)


#summary score: no data for 2014, 2016 and 2018

data_AFT_HRS_initial$jobstress = c(all_HRS_by_years_PGS$HRS2008_jobstress, 
...
length(unique(data_AFT_HRS_initial$ID_HRS))
summary(data_AFT_HRS_initial)
...
data_AFT_ELSA_table = data.table(data_AFT_ELSA_initial)
data_AFT_ELSA = na.omit(data_AFT_ELSA_table, cols = c("baseline_discriminaition",
                                                      "MI_outcome",
                                                      "PGS_mi"))
data_AFT_ELSA = as.data.frame(data_AFT_ELSA)
length(unique(data_AFT_ELSA$ID))
summary(data_AFT_ELSA)
data_AFT_ELSA$MI_outcome

#### ELSA, MI, discrim_bin AFT model 
# tried inits = function(t){ c(1, median(t)) }, for the error about the initial alues being non-finite...did not work as the error is now about the inits not being a numeric vector
...
ELSA_results_mi = AFT_model_PGS(data_AFT_input = data_AFT_ELSA,
                                baseline_discriminaition = "baseline_discriminaition", 
                                outcome = "MI_outcome",  
                                PGS = "PGS_mi",
                                distribution_AFT = "lnorm",                                                                  
                                OUTPUT_ROOT = OUTPUT_ROOT,  
                                alternative_cov = "diabetes_history", 
                                analysis_name = "ELSA_results_mi_AFT", 
                                plot_name = "ELSA, MI, AFT regression: ")
...
# ELSA_results_mi_glm = glm_model_PGS(data_glm_input = data_AFT_ELSA, 
#                                     baseline_discriminaition = "baseline_discriminaition", 
#                                     outcome = "MI_outcome",  
#                                     PGS = "PGS_mi",
#                                     OUTPUT_ROOT = OUTPUT_ROOT, 
...
# data_glm_ELSA_baseline_cases_mi = subset(data_AFT_ELSA, data_AFT_ELSA$time_point == 0 & data_AFT_ELSA$MI_outcome == 1) 
# baseline_cases_mi_uniqueIDs = unique(data_glm_ELSA_baseline_cases_mi$ID)
# 
# data_glm_ELSA_NObaseline_cases_mi <- data_AFT_ELSA[ !(data_AFT_ELSA$ID %in% c(baseline_cases_mi_uniqueIDs)), ]
# 
# 
...
data_AFT_HRS_table = data.table(data_AFT_HRS_initial)

data_AFT_HRS = na.omit(data_AFT_HRS_table, cols = c("baseline_discriminaition",
                                                    "MI_outcome",
                                                    "PGS_mi"))
data_AFT_HRS = as.data.frame(data_AFT_HRS)
length(unique(data_AFT_HRS$ID))
summary(data_AFT_HRS)
data_AFT_HRS$MI_outcome

#### HRS, MI, discrim_bin, AFT model 
HRS_results_mi = AFT_model_PGS(data_AFT_input = data_AFT_HRS, 
                               baseline_discriminaition = "baseline_discriminaition", 
                               outcome = "MI_outcome",  
                               PGS = "PGS_mi", 
                               distribution_AFT = "gamma",                                                                  
                               OUTPUT_ROOT = OUTPUT_ROOT,  
                               alternative_cov = "diabetes_history", 
                               analysis_name = "HRS_results_mi_AFT", 
...
# HRS_results_mi_glm = glm_model_PGS(data_glm_input = data_AFT_HRS, 
#                                    baseline_discriminaition = "baseline_discriminaition", 
#                                    outcome = "MI_outcome",  
#                                    PGS = "PGS_mi",
#                                    OUTPUT_ROOT = OUTPUT_ROOT, 
...
# data_glm_HRS_baseline_cases_mi = subset(data_AFT_HRS, data_AFT_HRS$time_point == 0 & data_AFT_HRS$MI_outcome == 1) 
# baseline_cases_mi_uniqueIDs = unique(data_glm_HRS_baseline_cases_mi$ID)
# 
# data_glm_HRS_NObaseline_cases_mi <- data_AFT_HRS[ !(data_AFT_HRS$ID %in% c(baseline_cases_mi_uniqueIDs)), ]
# 
# 
...
#### ELSA, diabetes, discrim_bin, AFT model  

ELSA_results_diabetes_AFT = AFT_model_PGS(data_AFT_input = data_AFT_ELSA,
                                          baseline_discriminaition = "baseline_discriminaition", 
                                          ...
                                          OUTPUT_ROOT = OUTPUT_ROOT,    
                                          alternative_cov = "BMI", 
                                          analysis_name = "ELSA_results_diab_AFT", 
...
# ELSA_results_diabetes_glm = glm_model_PGS(data_glm_input = data_AFT_ELSA, 
#                                           baseline_discriminaition = "baseline_discriminaition", 
#                                           outcome = "diabetes_outcome",  
#                                           PGS = "PGS_diab",
#                                           OUTPUT_ROOT = OUTPUT_ROOT, 
...
# data_glm_ELSA_baseline_cases = subset(data_AFT_ELSA, data_AFT_ELSA$time_point == 0 & data_AFT_ELSA$diabetes_outcome == 1) 
# baseline_cases_uniqueIDs = unique(data_glm_ELSA_baseline_cases$ID)
# 
# data_glm_ELSA_NObaseline_cases <- data_AFT_ELSA[ !(data_AFT_ELSA$ID %in% c(baseline_cases_uniqueIDs)), ]
# 
...
##### HRS, diabetes, discrim_bin AFT model

HRS_results_diabetes = AFT_model_PGS(data_AFT_input = data_AFT_HRS, 
                                     baseline_discriminaition = "baseline_discriminaition", 
                                     outcome = "diabetes_outcome",  
                                     PGS = "PGS_diab",
                                     ...
                                     analysis_name = "HRS_results_diab_AFT", 
                                     plot_name = "HRS, T2DM, AFT regression: ")
...
# HRS_results_diabetes_glm = glm_model_PGS(data_glm_input = data_AFT_HRS, 
#                                          baseline_discriminaition = "baseline_discriminaition", 
#                                          outcome = "diabetes_outcome",  
#                                          PGS = "PGS_diab",
#                                          OUTPUT_ROOT = OUTPUT_ROOT, 
...
# data_glm_HRS_baseline_cases = subset(data_AFT_HRS, data_AFT_HRS$time_point == 0 & data_AFT_HRS$diabetes_outcome == 1) 
# baseline_cases_uniqueIDs = unique(data_glm_HRS_baseline_cases$ID)
# 
# data_glm_HRS_NObaseline_cases <- data_AFT_HRS[ !(data_AFT_HRS$ID %in% c(baseline_cases_uniqueIDs)), ]
# 
...
# data_AFT_ELSA_initial = data.table(data_AFT_ELSA_initial)
# 
# data_glm_gaussian_ELSA = na.omit(data_AFT_ELSA_initial, cols = c("baseline_discriminaition",
#                                                                  "depressive_symptoms",
#                                                                  "PGS_depres_symp"))
...
# data_AFT_HRS_initial = data.table(data_AFT_HRS_initial)
# 
# data_glm_gaussian_HRS = na.omit(data_AFT_HRS_initial, cols = c("baseline_discriminaition",
#                                                                "depressive_symptoms",
#                                                                "PGS_depres_symp"))
